		...
		<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
			<TBODY>
				<TR>
					...
					[<A
														href="${pageContext.request.contextPath }/customer_listPage.action?currentPage=${pageBean.currentPage-1}">前一页</A>]
				</c:if>
												<c:if test="${pageBean.currentPage!=pageBean.totalPage }">
				[<A
														href="${pageContext.request.contextPath }/customer_listPage.action?currentPage=${pageBean.currentPage+1}">后一页</A>] 
