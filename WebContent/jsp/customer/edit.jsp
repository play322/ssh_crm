					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<TR>
								...
								<td>客户级别 ：</td>
								<td><select name="dictCusLevel.dno">

										<c:forEach var="dict" items="${listLevel }">
											<option value="${dict.dno }"
												<c:if test="${dict.dno == customer.dictCusLevel.dno}">selected</c:if>>
												${dict.dname }</option>
										</c:forEach>
								</select></td>
							</TR>
							...
							<TR>
								...
								<td>联系人：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_industry"
									value="${customer.cust_industry }"></td>
							</TR>
							<TR>
