...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkman_moreQuery.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人查询管理 &gt; 联系人综合查询</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
							...
							<tr>
								...
								<td colspan="3"><select name="customer.cust_id">
										...
										<c:forEach var="cus" items="${list }">
											<option value="${cus.cust_id }">${cus.cust_name }</option>
										</c:forEach>
								</select></td>
							</tr>
							<tr>
